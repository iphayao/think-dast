...
public class MyArrayListTest {
    ...
    /**
     * Test method for {@link MyArrayList#addAll(Collection)}.
     */
    @Test
    public void testAddAllCollectionOfQextendsT() {
        ...
        mylist.addAll(list);
        mylist.addAll(list);
        assertThat(mylist.size(), is(new Integer(12)));
    ...
    public void testClear() {
        mylist.clear();
        assertThat(mylist.size(), is(new Integer(0)));
    }
    ...
    /**
     * Test method for {@link MyArrayList#containsAll(Collection)}.
     */
    @Test
    ...
    /**
     * Test method for {@link MyArrayList#removeAll(Collection)}.
     */
    @Test
