...
public class Profiler extends ApplicationFrame {
    ...
    /**
     * This is here because extending ApplicationFrame require it.
     */
    public static final long serialVersionID = 1L;

    /**
     * Timeable defines the methods an objects must provide to work with Profiler
     */
    ...
    /**
     * Invokes timeIt with a range of `n` from `startN` until runtime exceeds `endMills`.
     * @param startN
     * @param endMillis
     * @return
     */
    public XYSeries timingLoop(int startN, int endMillis) {
        ...
        for(int i = 0; i < 20; i++) {
            ...
            // stop when the runtims exceeds the end threshold
            if(total > endMillis) {
                break;
            }
    ...
    public void plotResults(XYSeries series) {
        ...
        // customize the appearance fo the graph
