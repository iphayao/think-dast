...
public class ListSorter<T> {
    ...
    private List<T> mergeSort(List<T> list, Comparator<T> comparator) {
        ...
        // make two lists with half the element each
    ...
    private List<T> merge(List<T> first, List<T> second, Comparator<T> comparator) {
        // NOTE: using linkedList is importance because we need to remove
        // from beginning in constant time
    ...
    /**
     * Returns the list with smaller first element, according to 'comparator'
     *
     * @param first
     * @param second
     * @param comparator
